...
static class Appro_UnknownClass : public TclClass {
 public:
	Appro_UnknownClass() : TclClass("Queue/Appro_Unknown") {}
	TclObject* create(int, const char*const*) {
		return (new Appro_Unknown);
	}
} class_priority;

//#define INTERVAL 0.005

void Appro_Unknown::enque(Packet* p)
{
