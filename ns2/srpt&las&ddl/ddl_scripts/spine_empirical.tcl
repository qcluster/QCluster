...
Agent/TCP/FullTcp set enable_ddl_ true
...
if {[string compare $switchAlg "Appro_Known"] == 0 } {
    Agent/TCP/FullTcp set enable_known_ true
}
if {[string compare $switchAlg "FQ_Known"] == 0 } {
    Agent/TCP/FullTcp set enable_known_ true
}
...
Queue/Known set queue_num_ $prio_num_
Queue/Known set thresh_ $DCTCP_K
Queue/Known set mean_pktsize_ [expr $pktSize+40]
Queue/Known set marking_scheme_ $ECN_scheme_
