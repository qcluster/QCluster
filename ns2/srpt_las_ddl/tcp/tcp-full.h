...
public:
	FullTcpAgent() :
		prio_scheme_(0), prio_num_(0), startseq_(0), pias_startseq_(0), connection_(0), last_prio_(0), seq_bound_(0),
		closed_(0), pipe_(-1), rtxbytes_(0), fastrecov_(FALSE),
		  ...
		  informpacer(0), enable_pias_(0), thres_message_(0.0), enable_known_(0), enable_ddl_(0), pias_prio_num_(0), pias_debug_(0) { }
